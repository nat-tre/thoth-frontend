...
const Navbar = () => {
	return (
		<div className="w-screen fixed bg-white border-b-2 top-0 mx-auto py-2 px-5 z-10">
			<div className="w-full flex items-center justify-between">
				<a
					className="flex flex-grow items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
					href="#"
				>
					<svg
